...
q1_2020<-read.csv("C:/Users/Administrator/Documents/Case Study Cyclistic/data/2020/Divvy_Trips_2020_Q1.csv")
...
all_trips <- bind_rows(q1_2020, q2_2020, q3_2020, q4_2020, q1_2021)
...
all_trips_v2 <- subset(all_trips_v2, ride_length !=0)
...
# Compare the number or rides by each day for members vs casual users
...
# Compare the number or rides for members vs casual users 
